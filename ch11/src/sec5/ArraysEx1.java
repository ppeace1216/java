...
public class ArraysEx1 {
	...
	public static void main(String[] args) {
		...
		char[] arr3 = Arrays.copyOfRange(arr, 0, 4);	//일부만 복사
		System.out.println(arr3);
		
		System.out.println("같은지 비교 1 : "+(arr==arr2));	//주소비교
		System.out.println("같은지 비교 2 : "+Arrays.equals(arr, arr2));
//		System.out.println("같은지 비교 3 : "+Arrays.deepEquals(arr, arr2));		같은 기억장소를 의미하는 주소가 다를 경우 서로 비교될 수 없다.
		
		int[] jum = {95, 100, 85, 90, 80};
		Arrays.sort(jum);		//오름차순 정렬 p.564
		for(int pt : jum){
